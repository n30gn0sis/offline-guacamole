...
| 2 | Fail the release early | A release build runs the local check before pulling/saving/packaging, and stops before the expensive steps if it fails | complete | .claude/plans/fail-release-early.plan.md |
